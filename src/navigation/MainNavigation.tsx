                ...
                headerRight: ["Settings"].includes(route.name) ? () => {
                    return (
                        <TouchableHighlight onPress={() => navigation.goBack()}>
                            <Image source={require('./../assets/img/close.png')} style={{width: 25, height:25, resizeMode:'contain'}} />
                        </TouchableHighlight>
                    );
                } : () => {
                    return (
                        <TouchableHighlight onPress={() => navigation.navigate('Settings')}>
                            <Image source={require('./../assets/img/settings.png')} style={{width: 25, height:25, resizeMode:'contain'}} />
                        </TouchableHighlight>
                    );
                },
                tabBarStyle: {
